        ...
        <div className="navbar flex items-center justify-between w-[95%] mt-4 px-4    mx-auto bg-white shadow-lg shadow-slate-100 rounded-md">
            <div className="left flex gap-5">
                ...
                <div className="search w-fit sm:flex hidden h-11 my-auto rounded-2xl bg-slate-100 hover:border hover:border-blue-300 focus-within:border focus-within:border-blue-500">
                    ...
                    <div className="search-icon bg-sky-200 h-full w-12 flex justify-center items-center rounded-2xl">
            ...
            <div className="right flex">
                ...
                <div
                    className="flex justify-center float-start items-center relative transition-all duration-[450ms] ease-in-out w-auto"
                >
                    <article
                        className=" w-full ease-in-out duration-500 left-0  flex "
                    >
                        <label
                            className="has-[:checked]:shadow-lg  hidden relative w-full h-16 p-4 ease-in-out duration-300 border-solid border-black/10 has-[:checked]:border group md:flex flex-row gap-3 items-center justify-center text-black rounded-xl"
                            for="dashboard"
                        >
                            <input
                                id="dashboard"
                        ...
                        <label
                            ...
                            for="profile"
                        >
                            <input id="profile" name="path" type="radio" className="hidden peer/expand" />
                            <svg
                                viewBox="0 0 24 24"
                                height="24"
                                width="24"
                        ...
                        <label
                            className="has-[:checked]:shadow-lg relative w-full h-16 p-4 ease-in-out duration-300 border-solid border-black/10 has-[:checked]:border group md:flex hidden flex-row gap-3 items-center justify-center text-black rounded-xl"
                            for="messages"
                        >
                            <input
                                id="messages"
                        ...
                        <label
                            ...
                            for="help"
                        >
                            <input id="help" name="path" type="radio" className="hidden peer/expand" />
                            <svg
                                viewBox="0 0 24 24"
                                height="24"
                                width="24"
