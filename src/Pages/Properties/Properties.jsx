...
export default function Properties() {
    ...
    return (
        <>
            <div className="welcome-badge relative w-full md:h-[500px] sm:h-72 h-56">
                ...
                <div className="shape absolute md:bottom-0 -bottom-1 right-0 left-0 md:h-20 h-9 rounded-t-full bg-white"></div>
            </div>
            <div className="properties-body w-5/6  mx-auto">
                <p className="text-center text-sky-900 md:text-4xl baloo text-xl mt-10 mb-4">
